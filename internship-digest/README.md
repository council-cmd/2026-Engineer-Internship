...
It runs on GitHub's own machines, which have unrestricted internet - that is
what lets it open job pages and read descriptions.
...
| `data/latest_digest.json` | A machine-readable record of the most recent run |
